...
Received: from bendel.debian.org (bendel.debian.org [82.195.75.100])
	by mail.lfdr.de (Postfix) with ESMTPS id A74F8766E5
	for <lists+nbd@lfdr.de>; Fri, 26 Jul 2019 15:06:12 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by bendel.debian.org (Postfix) with QMQP
	id 8B29D201F1; Fri, 26 Jul 2019 13:06:12 +0000 (UTC)
X-Mailbox-Line: From nbd-request@other.debian.org  Fri Jul 26 13:06:12 2019
Old-Return-Path: <bastian.guggenheim@bluewin.ch>
X-Spam-Checker-Version: SpamAssassin 3.4.2 (2018-09-13) on bendel.debian.org
X-Spam-Level: **
X-Spam-Status: No, score=2.9 required=4.0 tests=FOURLA,HTML_MESSAGE,
	LOTS_OF_MONEY,MONEY,RCVD_IN_DNSWL_LOW,STOCKLIKE,T_HK_SPAMMY_FILENAME
	autolearn=no autolearn_force=no version=3.4.2
X-Original-To: lists-other-nbd@bendel.debian.org
Delivered-To: lists-other-nbd@bendel.debian.org
Received: from localhost (localhost [127.0.0.1])
	by bendel.debian.org (Postfix) with ESMTP id 366D0202D8
	for <lists-other-nbd@bendel.debian.org>; Fri, 26 Jul 2019 12:50:32 +0000 (UTC)
X-Virus-Scanned: at lists.debian.org with policy bank en-lt
X-Amavis-Spam-Status: No, score=2.941 tagged_above=-10000 required=5.3
	tests=[FOURLA=0.1, HTML_MESSAGE=2, LOTS_OF_MONEY=0.001, MONEY=0.5,
	RCVD_IN_DNSWL_LOW=-0.7, STOCKLIKE=1, T_HK_SPAMMY_FILENAME=0.01,
	UNWANTED_LANGUAGE_BODY=0.03] autolearn=no autolearn_force=no
Received: from bendel.debian.org ([127.0.0.1])
	by localhost (lists.debian.org [127.0.0.1]) (amavisd-new, port 2525)
	with ESMTP id o2f1AWSfol4L for <lists-other-nbd@bendel.debian.org>;
	Fri, 26 Jul 2019 12:50:28 +0000 (UTC)
X-policyd-weight: using cached result; rate: -5.5
X-Greylist: delayed 367 seconds by postgrey-1.36 at bendel; Fri, 26 Jul 2019 12:50:28 UTC
Received: from vimdzmsp-mail04.bluewin.ch (vimdzmsp-mail04.bluewin.ch [195.186.227.121])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(Client CN "Client", Issuer "CA" (not verified))
	by bendel.debian.org (Postfix) with ESMTPS id 1CF1E202DE
	for <nbd@other.debian.org>; Fri, 26 Jul 2019 12:50:28 +0000 (UTC)
Received: from vimdzmsp-rich13.bluewin.ch ([195.186.122.145])
	by vimdzmsp-mail04.bluewin.ch Swisscom AG with SMTP
	id qza1h2Cgoe3W1qza1hw24A; Fri, 26 Jul 2019 14:44:19 +0200
X-Bluewin-Spam-Analysis: v=2.1 cv=XIT9MVVE c=1 sm=1 tr=0
...
X-CMAE-Envelope: 
X-Rc-Spam: 2008-11-04_01
X-Rc-Virus: 2007-09-13_01
X-Rc-Spam: 2008-11-04_01
Resent-Message-ID: <Bn3kPNdRLdN.A.sMG.ErvOdB@bendel>
Resent-From: nbd@other.debian.org
X-Mailing-List: <nbd@other.debian.org> archive/latest/603
...
List-Archive: https://lists.debian.org/msgid-search/1311103227.16247.1564145053464@bluewin.ch
Resent-Date: Fri, 26 Jul 2019 13:06:12 +0000 (UTC)
