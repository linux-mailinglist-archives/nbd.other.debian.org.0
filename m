...
Received: from bendel.debian.org (bendel.debian.org [IPv6:2001:41b8:202:deb:216:36ff:fe40:4002])
	by mail.lfdr.de (Postfix) with ESMTPS id D43053F98EA
	for <lists+nbd@lfdr.de>; Fri, 27 Aug 2021 14:14:49 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by bendel.debian.org (Postfix) with QMQP
	id 5F43B209E2; Fri, 27 Aug 2021 12:14:49 +0000 (UTC)
X-Mailbox-Line: From nbd-request@other.debian.org  Fri Aug 27 12:14:49 2021
...
X-Spam-Status: No, score=-8.6 required=4.0 tests=DIGITS_LETTERS,DKIMWL_WL_HIGH,
	...
	REMOVEDOT autolearn=unavailable autolearn_force=no version=3.4.2
X-Original-To: lists-other-nbd@bendel.debian.org
Delivered-To: lists-other-nbd@bendel.debian.org
Received: from localhost (localhost [127.0.0.1])
	by bendel.debian.org (Postfix) with ESMTP id 60B0D20958
	for <lists-other-nbd@bendel.debian.org>; Fri, 27 Aug 2021 12:14:40 +0000 (UTC)
X-Virus-Scanned: at lists.debian.org with policy bank en-lt
X-Amavis-Spam-Status: No, score=-4.548 tagged_above=-10000 required=5.3
	tests=[BAYES_00=-2, DIGITS_LETTERS=1, DKIMWL_WL_HIGH=-0.747,
	DKIM_SIGNED=0.1, DKIM_VALID=-0.1, DKIM_VALID_AU=-0.1,
	DKIM_VALID_EF=-0.1, FOURLA=0.1, LDO_WHITELIST=-5,
	RCVD_IN_DNSWL_LOW=-0.7, RCVD_IN_MSPIKE_H2=-0.001, REMOVEDOT=3]
	autolearn=no autolearn_force=no
Received: from bendel.debian.org ([127.0.0.1])
	by localhost (lists.debian.org [127.0.0.1]) (amavisd-new, port 2525)
	with ESMTP id vWzp00NRHk6J for <lists-other-nbd@bendel.debian.org>;
	Fri, 27 Aug 2021 12:14:35 +0000 (UTC)
X-policyd-weight: using cached result; rate: -5.5
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	by bendel.debian.org (Postfix) with ESMTP id 4330420955
	for <nbd@other.debian.org>; Fri, 27 Aug 2021 12:14:35 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1630066469;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=YaWeb9afp9KjyZpzFfNRxk5cDuMcX7o0gLNMktplqd4=;
	b=BkvsQwM5ZYrRv7nH9bg8HRWXg5JvAQtV3I/9GCUyepUYvSBvaEBHPW+bJBsWchmQYV+XVF
	SxRQG3i+IRtGivsuVpAWgzFWXOhSTSnsLcuhnSDgeV+r8MWKCMRvEWSZz7qMUxCnKK5YHV
	eimZB/0Jtcls2wJLMiMxHir9GoCqFg0=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-58-okg9ItAXPDW_ox6EQfVudw-1; Fri, 27 Aug 2021 08:14:22 -0400
X-MC-Unique: okg9ItAXPDW_ox6EQfVudw-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com [10.5.11.22])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 9CFE5100A605;
	Fri, 27 Aug 2021 12:14:21 +0000 (UTC)
Received: from localhost (unknown [10.39.192.185])
	by smtp.corp.redhat.com (Postfix) with ESMTP id EA7EE10074F5;
	Fri, 27 Aug 2021 12:14:20 +0000 (UTC)
Date: Fri, 27 Aug 2021 13:14:20 +0100
From: "Richard W.M. Jones" <rjones@redhat.com>
To: Simon Fernandez <fernandez.simon@gmail.com>
Cc: eblake@redhat.com, Wouter Verhelst <w@uter.be>, nbd@other.debian.org
Subject: Re: Setting up NBD server / client - block nbd4: Other side returned
 error (22) issue
Message-ID: <20210827121420.GN26415@redhat.com>
References: <BE35A3E0-1FA0-4F2C-B72B-6BFA5184823D@gmail.com>
 ...
 <ADAB45CE-7688-4122-B777-59967727226E@gmail.com>
MIME-Version: 1.0
In-Reply-To: <ADAB45CE-7688-4122-B777-59967727226E@gmail.com>
...
Resent-Message-ID: <Pg7lx4HO64M.A.e_G.5cNKhB@bendel>
Resent-From: nbd@other.debian.org
X-Mailing-List: <nbd@other.debian.org> archive/latest/1346
...
List-Archive: https://lists.debian.org/msgid-search/20210827121420.GN26415@redhat.com
Resent-Date: Fri, 27 Aug 2021 12:14:49 +0000 (UTC)

On Fri, Aug 27, 2021 at 12:46:40PM +0100, Simon Fernandez wrote:
> Thanks For the swift reply Richard!
> 
> Ive just realised it’s you blog I’ve been reading! (Love the 'about the author'
> bit ; ) )
> 
...
> [rpi-C3-food]
> exportname = /dev/sda
> transactionlog = /home/pi/media/500G_FAITH/logs/log_food
> readonly = false

This will export /dev/sda (writably) and as long as /dev/sda is not
used by anything else that's fine.  However if /dev/sda is something
that might contain your root filesystem or is mounted on the host
anywhere then it's NOT fine, and in fact will certainly lead to
unrecoverable disk corruption.

If you're looking for an NBD export that is safe to play with, can I
suggest the nbdkit memory plugin?  It's a sparse RAM disk and can't do
anything worse than cause your machine to run out of memory if you
fill it up too much.

https://libguestfs.org/nbdkit-memory-plugin.1.html

If you want to export some random files, I'd still suggest floppy
plugin or the similar related plugins in nbdkit.
...
> nbdinfo: nbd_set_export_name: invalid state: READY: the handle must be newly
> created, or negotiating: Invalid argument
> 
> 
> 
> 
> 
>     On 26 Aug 2021, at 20:48, Richard W.M. Jones <rjones@redhat.com> wrote:
> 
...
> 
>                Hi folks,
>                I’m trying setup a client that connect to a 500Gb ext4 disk on
>         another
>                machine
>                running nbd server.
...
>                and a lot of other sites but I think I’m doing something wrong
>         on the
>                server
>                setup because I get this on the client:
> 
>                $ sudo mount /dev/nbd2 /home/pi/Vols/nbd1-recipes/
>                mount: /home/pi/Vols/nbd1-recipes: can't read superblock on /dev
>         /nbd2
> 
...
>                file.
> 
>                This is how I’ve set up the server & client, it’s probably
>         something
>                obvious to
...
>                [ 1417.884652] blk_update_request: I/O error, dev nbd1, sector 0
>         op
>                0x0:(READ)
>                flags 0x0 phys_seg 1 prio class 0
...
>                [ 1417.886016] blk_update_request: I/O error, dev nbd1, sector 0
>         op
>                0x0:(READ)
>                flags 0x0 phys_seg 1 prio class 0
...
> 
>                    sudo nbd-client 192.168.1.14 -d /dev/nbd1 # thought it might
>         be
>                    something to
> 
>                do w/ nbd1
...
>                (LISTEN)
> 
>                I’d be very grateful for any pointers, or other resources that
>         my be of
>                help.
>                Thanks in advance,
>                Simon
