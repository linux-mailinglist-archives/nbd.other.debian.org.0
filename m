...
Received: from bendel.debian.org (bendel.debian.org [IPv6:2001:41b8:202:deb:216:36ff:fe40:4002])
	by mail.lfdr.de (Postfix) with ESMTPS id F2F3D4A6E53
	for <lists+nbd@lfdr.de>; Wed,  2 Feb 2022 11:03:10 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by bendel.debian.org (Postfix) with QMQP
	id D0F712038D; Wed,  2 Feb 2022 10:03:10 +0000 (UTC)
X-Mailbox-Line: From nbd-request@other.debian.org  Wed Feb  2 10:03:10 2022
Old-Return-Path: <hdanton@sina.com>
X-Spam-Checker-Version: SpamAssassin 3.4.2 (2018-09-13) on bendel.debian.org
X-Spam-Level: 
X-Spam-Status: No, score=-0.6 required=4.0 tests=DIGITS_LETTERS,FOURLA,
	FREEMAIL_FROM,FVGT_m_MULTI_ODD,MD5_SHA1_SUM,RCVD_IN_DNSWL_LOW,
	RCVD_IN_MSPIKE_H3,RCVD_IN_MSPIKE_WL,T_SCC_BODY_TEXT_LINE autolearn=no
	autolearn_force=no version=3.4.2
X-Original-To: lists-other-nbd@bendel.debian.org
Delivered-To: lists-other-nbd@bendel.debian.org
Received: from localhost (localhost [127.0.0.1])
	by bendel.debian.org (Postfix) with ESMTP id 500FB2038A
	for <lists-other-nbd@bendel.debian.org>; Wed,  2 Feb 2022 09:45:50 +0000 (UTC)
X-Virus-Scanned: at lists.debian.org with policy bank en-lt
X-Amavis-Spam-Status: No, score=-2.577 tagged_above=-10000 required=5.3
...
Received: from bendel.debian.org ([127.0.0.1])
	...
	with ESMTP id mHNC3FiJbMI7 for <lists-other-nbd@bendel.debian.org>;
	Wed,  2 Feb 2022 09:45:46 +0000 (UTC)
...
X-Greylist: delayed 1199 seconds by postgrey-1.36 at bendel; Wed, 02 Feb 2022 09:45:45 UTC
Received: from r3-25.sinamail.sina.com.cn (r3-25.sinamail.sina.com.cn [202.108.3.25])
	by bendel.debian.org (Postfix) with SMTP id B07EB20380
	for <nbd@other.debian.org>; Wed,  2 Feb 2022 09:45:41 +0000 (UTC)
Received: from unknown (HELO localhost.localdomain)([114.249.61.131])
	by sina.com (172.16.97.23) with ESMTP
	id 61FA4E030001CA8F; Wed, 2 Feb 2022 17:25:24 +0800 (CST)
X-Sender: hdanton@sina.com
X-Auth-ID: hdanton@sina.com
X-SMAIL-MID: 87947454919290
From: Hillf Danton <hdanton@sina.com>
To: Dmitry Vyukov <dvyukov@google.com>,
	syzbot <syzbot+476bd1c816c8c9c340d7@syzkaller.appspotmail.com>
Cc: axboe@kernel.dk,
...
Date: Wed,  2 Feb 2022 17:25:26 +0800
Message-Id: <20220202092526.1957-1-hdanton@sina.com>
In-Reply-To: <CACT4Y+bHXX3_VdvGcKMS3x4Jks_iejdPi7JhPwCNA8MnQGZEew@mail.gmail.com>
...
X-Rc-Spam: 2008-11-04_01
Resent-Message-ID: <JMmgbLGKMdC.A.7vF.ebl-hB@bendel>
Resent-From: nbd@other.debian.org
X-Mailing-List: <nbd@other.debian.org> archive/latest/1712
...
List-Archive: https://lists.debian.org/msgid-search/20220202092526.1957-1-hdanton@sina.com
Resent-Date: Wed,  2 Feb 2022 10:03:10 +0000 (UTC)

On Tue, 1 Feb 2022 08:50:49 +0100 Dmitry Vyukov wrote:
...
The syzbot report could be down to the race between two ioctl pathes
that both survive the NBD_RT_BOUND check prior to __nbd_ioctl().
	...
	NBD_DO_IT		  NBD_SET_SOCK
	nbd_start_device_ioctl()  nbd_add_socket()	recv_work()
...
And fix it by flushing pending workers.

Another fix is to check pending workers before realloc and bail out in
case of any worker scheduled.
...
@@ -1121,6 +1121,8 @@ static int nbd_add_socket(struct nbd_dev
 		goto put_socket;
 	}
