...
Received: from bendel.debian.org (bendel.debian.org [IPv6:2001:41b8:202:deb:216:36ff:fe40:4002])
	by mail.lfdr.de (Postfix) with ESMTPS id 31A66710CEE
	for <lists+nbd@lfdr.de>; Thu, 25 May 2023 15:03:11 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by bendel.debian.org (Postfix) with QMQP
	id 16BEF204FA; Thu, 25 May 2023 13:03:11 +0000 (UTC)
X-Mailbox-Line: From nbd-request@other.debian.org  Thu May 25 13:03:11 2023
...
Received: from localhost (localhost [127.0.0.1])
	by bendel.debian.org (Postfix) with ESMTP id 7902220461
	for <lists-other-nbd@bendel.debian.org>; Thu, 25 May 2023 13:01:59 +0000 (UTC)
...
Received: from bendel.debian.org ([127.0.0.1])
	...
	with ESMTP id j1MhAhn4nNmr for <lists-other-nbd@bendel.debian.org>;
	Thu, 25 May 2023 13:01:52 +0000 (UTC)
X-policyd-weight: using cached result; rate: -5.5
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	by bendel.debian.org (Postfix) with ESMTP id 38F9C2050D
	for <nbd@other.debian.org>; Thu, 25 May 2023 13:01:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1685019697;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=hKyK2TAYxPpTfm6PQlH04DokzHH1strrREfrc7GBB6M=;
	b=ElHYQ/WEF1/NBrrHkToWCBItWZSBFDjDUy7k0E63J58e3EabnEK/9zCz3iQwliAxxGE3va
	SGlzIQf4/pOk2415WArgjWnD2dGeJO0F37FUFmSbRkdPbCjmirr060SXm6EC7h4YtmyLPY
	EFgObb5TeL5ZrU5b/NrHNUaHyHi/bYw=
Received: from mimecast-mx02.redhat.com (mx3-rdu2.redhat.com
 [66.187.233.73]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-278-eLThVW-4PmaRHxPEds1A_g-1; Thu, 25 May 2023 09:01:21 -0400
X-MC-Unique: eLThVW-4PmaRHxPEds1A_g-1
Received: from smtp.corp.redhat.com (int-mx10.intmail.prod.int.rdu2.redhat.com [10.11.54.10])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id E077A28135BB;
	Thu, 25 May 2023 13:01:13 +0000 (UTC)
Received: from green.redhat.com (unknown [10.2.16.46])
	by smtp.corp.redhat.com (Postfix) with ESMTP id 8C6C8492B0A;
	Thu, 25 May 2023 13:01:13 +0000 (UTC)
From: Eric Blake <eblake@redhat.com>
To: libguestfs@redhat.com
Cc: qemu-block@nongnu.org,
	nbd@other.debian.org
Subject: [libnbd PATCH v3 10/22] api: Add [aio_]nbd_block_status_64
Date: Thu, 25 May 2023 08:00:56 -0500
Message-Id: <20230525130108.757242-11-eblake@redhat.com>
...
Resent-Message-ID: <24zi3SsppeP.A.FnG.Py1bkB@bendel>
Resent-From: nbd@other.debian.org
X-Mailing-List: <nbd@other.debian.org> archive/latest/2492
...
List-Archive: https://lists.debian.org/msgid-search/20230525130108.757242-11-eblake@redhat.com
Resent-Date: Thu, 25 May 2023 13:03:11 +0000 (UTC)
...
---
 ...
 13 files changed, 527 insertions(+), 48 deletions(-)
...
index 72f74053..ddbb09f3 100644
--- a/docs/libnbd.pod
+++ b/docs/libnbd.pod
...
index 1da1ec53..f04f4b79 100644
--- a/generator/API.ml
+++ b/generator/API.ml
...
index ea3b044a..b05cd1d2 100644
...
index ccac5fed..6f87b0cf 100644
...
index 58b05a4b..bea55fa1 100644
--- a/lib/rw.c
+++ b/lib/rw.c
