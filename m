...
Received: from bendel.debian.org (bendel.debian.org [82.195.75.100])
	by mail.lfdr.de (Postfix) with ESMTPS id 73F7F905681
	for <lists+nbd@lfdr.de>; Wed, 12 Jun 2024 17:12:17 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by bendel.debian.org (Postfix) with QMQP
	id 42CAF207E5; Wed, 12 Jun 2024 15:12:17 +0000 (UTC)
X-Mailbox-Line: From nbd-request@other.debian.org  Wed Jun 12 15:12:17 2024
...
Received: from localhost (localhost [127.0.0.1])
	by bendel.debian.org (Postfix) with ESMTP id 4A244207D3
	for <lists-other-nbd@bendel.debian.org>; Wed, 12 Jun 2024 14:54:24 +0000 (UTC)
...
Received: from bendel.debian.org ([127.0.0.1])
	...
	with ESMTP id eKEQQpcMi1n5 for <lists-other-nbd@bendel.debian.org>;
	Wed, 12 Jun 2024 14:54:13 +0000 (UTC)
X-policyd-weight:  NOT_IN_SBL_XBL_SPAMHAUS=-1.5 CL_IP_EQ_HELO_IP=-2 (check from: .linaro. - helo: .mail-yw1-x112f.google. - helo-domain: .google.)  FROM/MX_MATCHES_HELO(DOMAIN)=-2; rate: -5.5
Received: from mail-yw1-x112f.google.com (mail-yw1-x112f.google.com [IPv6:2607:f8b0:4864:20::112f])
	(using TLSv1.3 with cipher TLS_AES_128_GCM_SHA256 (128/128 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256
	 client-signature RSA-PSS (2048 bits) client-digest SHA256)
	(Client CN "smtp.gmail.com", Issuer "WR4" (not verified))
	by bendel.debian.org (Postfix) with ESMTPS id 2E92E207D1
	for <nbd@other.debian.org>; Wed, 12 Jun 2024 14:54:09 +0000 (UTC)
Received: by mail-yw1-x112f.google.com with SMTP id 00721157ae682-62a2424ed00so69288727b3.1
        for <nbd@other.debian.org>; Wed, 12 Jun 2024 07:54:09 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google; t=1718204047; x=1718808847; darn=other.debian.org;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=bziVRdXSiVshwhhdlB5Zfeta9rMg2I/94yUew4zEeXk=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         ...
         :reply-to;
        bh=bziVRdXSiVshwhhdlB5Zfeta9rMg2I/94yUew4zEeXk=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVhDgvo+q5QztAqLOZsowkElZByPGR5vG1SoavkTVWEwOJ2ytgzVo4L9oGCF9mAlEzFKOMmCnsjPJfgZqRV0U8ZiStpbg==
X-Gm-Message-State: AOJu0YxwfbqqGRDYo7U4FdWfDhBp6Cb5O6xhHvPpaOP9exAarDBvf9oh
	L1Q7YG917PRAem7YG2JSJUbn8TuhsGVQ33G3TPHWrMAD5SP/wSb2caIcAAYXE5I+H9ek+etkESo
	vW8rhYOjvitvckGbr+41Ocgw5FyhIVTW8TwS1Dg==
...
X-Rc-Spam: 2008-11-04_01
Resent-Message-ID: <7hFRG_WRkCO.A.WejH.RrbamB@bendel>
Resent-From: nbd@other.debian.org
X-Mailing-List: <nbd@other.debian.org> archive/latest/2987
...
List-Archive: https://lists.debian.org/msgid-search/CAPDyKFrv+Gg=BKzKN249MiQy+bPCRALM-LL-zyhbJ38GHtHgAA@mail.gmail.com
Resent-Date: Wed, 12 Jun 2024 15:12:17 +0000 (UTC)
